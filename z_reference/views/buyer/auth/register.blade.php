...
<body class="bg-background text-primary min-h-screen flex items-center justify-center p-4 transition-colors duration-300">
    ...
    <div class="w-full max-w-md bg-surface border border-border p-8 rounded-xl shadow-2xl">
        <div class="text-center mb-8">
            <h1 class="text-3xl font-bold tracking-tight text-primary mb-2">Gabung Onedayez</h1>
            <p class="text-secondary text-sm">Mulai koleksi cheat code kamu hari ini.</p>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-6">
            ...
            <!-- Username -->
            <div>
                <label for="username" class="block text-sm font-medium text-secondary mb-2">Username Kece</label>
            ...
            <!-- Email Address -->
            <div>
                <label for="email" class="block text-sm font-medium text-secondary mb-2">Email Kamu</label>
            ...
            <!-- Password -->
            <div>
                <label for="password" class="block text-sm font-medium text-secondary mb-2">Kata Sandi Rahasia</label>
             ...
             <!-- Confirm Password -->
             <div>
                <label for="password_confirmation" class="block text-sm font-medium text-secondary mb-2">Ulangi Sandi</label>
            ...
            <div class="text-center mt-4">
                <a href="{{ route('login') }}" class="text-xs text-secondary hover:text-primary underline">
