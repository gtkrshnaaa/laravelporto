...
<body class="bg-background text-primary min-h-screen flex items-center justify-center p-4 transition-colors duration-300">
    ...
    <div class="w-full max-w-md bg-surface border border-border p-8 rounded-xl shadow-2xl">
        <div class="text-center mb-8">
            <h1 class="text-3xl font-bold tracking-tight text-primary mb-2">Masuk Dulu Yuk</h1>
            <p class="text-secondary text-sm">Akses wishlist dan cheat code belajar kamu.</p>
        </div>
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-6">
            ...
            <div class="text-center mt-4">
                <a href="{{ route('register') }}" class="text-sm text-secondary hover:text-primary transition-colors">
                    Belum punya akun? Gabung yuk!
                </a>
            </div>
        </form>
    </div>
