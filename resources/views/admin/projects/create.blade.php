...
@section('content')
    <div class="max-w-4xl">
        <div class="mb-8">
            <h2 class="text-3xl font-bold text-primary mb-2">Create New Project</h2>
            <p class="text-secondary">Add a new project to your portfolio.</p>
        </div>

        <form action="{{ route('admin.projects.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6" x-data="{
            techStack: [],
            newTech: '',
            addTech() {
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    @enderror
                    <p class="text-xs text-secondary mt-1">Slug will be auto-generated from title</p>
                </div>
                ...
                <div>
                    ...
                    <input id="live_url" type="url" name="live_url" value="{{ old('live_url') }}" placeholder="https://..."
                        class="w-full bg-background border border-border rounded-lg px-4 py-3 text-primary focus:ring-1 focus:ring-primary focus:border-primary transition-colors outline-none placeholder-secondary font-mono text-sm">
                    @error('live_url')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div class="md:col-span-2">
                    ...
                    <p class="text-xs text-secondary mt-1">Recommended: 1200x800px, max 2MB</p>
                ...
                <div class="md:col-span-2">
                    <div class="flex items-center gap-2">
                        <input type="checkbox" id="is_featured" name="is_featured" value="1" {{ old('is_featured') ? 'checked' : '' }} class="w-4 h-4 rounded border-border bg-background text-primary focus:ring-0">
